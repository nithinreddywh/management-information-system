...
Partial Public Class Database1DataSet
    ...
    Partial Public Class BILLDataTable
        ...
        Private columnmeterValue As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public ReadOnly Property meterValueColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnmeterValue
            End Get
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddBILLRow(ByVal Id As Integer, ByVal name As String, ByVal meterValue As Double, ByVal amount As Double) As BILLRow
            Dim rowBILLRow As BILLRow = CType(Me.NewRow,BILLRow)
            Dim columnValuesArray() As Object = New Object() {Id, name, meterValue, amount}
        ...
        Friend Sub InitVars()
            ...
            Me.columnmeterValue = MyBase.Columns("meterValue")
        ...
        Private Sub InitClass()
            ...
            Me.columnmeterValue = New Global.System.Data.DataColumn("meterValue", GetType(Double), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnmeterValue)
    ...
    Partial Public Class BILLRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Property meterValue() As Double
            Get
                Try 
                    Return CType(Me(Me.tableBILL.meterValueColumn),Double)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'meterValue' in table 'BILL' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableBILL.meterValueColumn) = value
            End Set
        End Property
        ...
        Public Property amount() As Double
            Get
                Try 
                    Return CType(Me(Me.tableBILL.amountColumn),Double)
                Catch e As Global.System.InvalidCastException
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function IsmeterValueNull() As Boolean
            Return Me.IsNull(Me.tableBILL.meterValueColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetmeterValueNull()
            Me(Me.tableBILL.meterValueColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace Database1DataSetTableAdapters
    ...
    Partial Public Class BILLTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            tableMapping.ColumnMappings.Add("meterValue", "meterValue")
            tableMapping.ColumnMappings.Add("amount", "amount")
            Me._adapter.TableMappings.Add(tableMapping)
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[BILL] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND "& _ 
                "[name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_meterValue = 1 AND ["& _ 
                "meterValue] IS NULL) OR ([meterValue] = @Original_meterValue)) AND ((@IsNull_amo"& _ 
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IsNull_meterValue", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "meterValue", Global.System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_meterValue", Global.System.Data.SqlDbType.Float, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "meterValue", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[BILL] ([Id], [name], [meterValue], [amount]) VALUES (@Id, @nam"& _ 
                "e, @meterValue, @amount);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, name, meterValue, amount FROM BILL WHERE ("& _ 
                "Id = @Id)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@meterValue", Global.System.Data.SqlDbType.Float, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "meterValue", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[BILL] SET [Id] = @Id, [name] = @name, [meterValue] = @meterValue, ["& _ 
                "amount] = @amount WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name]"& _ 
                " IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_meterValue = 1 AND [meterV"& _ 
                "alue] IS NULL) OR ([meterValue] = @Original_meterValue)) AND ((@IsNull_amount = "& _ 
                "1 AND [amount] IS NULL) OR ([amount] = @Original_amount)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, name, me"& _ 
                "terValue, amount FROM BILL WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@meterValue", Global.System.Data.SqlDbType.Float, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "meterValue", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IsNull_meterValue", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "meterValue", Global.System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_meterValue", Global.System.Data.SqlDbType.Float, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "meterValue", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global._18_ELECTRICITY_BILL.My.MySettings.Default.Database1ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, name, meterValue, amount FROM dbo.BILL"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_name As String, ByVal Original_meterValue As Global.System.Nullable(Of Double), ByVal Original_amount As Global.System.Nullable(Of Double)) As Integer
            ...
            End If
            If (Original_meterValue.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(3).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(4).Value = CType(Original_meterValue.Value,Double)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal Id As Integer, ByVal name As String, ByVal meterValue As Global.System.Nullable(Of Double), ByVal amount As Global.System.Nullable(Of Double)) As Integer
            ...
            End If
            If (meterValue.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(meterValue.Value,Double)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal Id As Integer, ByVal name As String, ByVal meterValue As Global.System.Nullable(Of Double), ByVal amount As Global.System.Nullable(Of Double), ByVal Original_Id As Integer, ByVal Original_name As String, ByVal Original_meterValue As Global.System.Nullable(Of Double), ByVal Original_amount As Global.System.Nullable(Of Double)) As Integer
            ...
            End If
            If (meterValue.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(meterValue.Value,Double)
            Else
            ...
            If (Original_meterValue.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_meterValue.Value,Double)
            Else
            ...
            If (Original_amount.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_amount.Value,Double)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal name As String, ByVal meterValue As Global.System.Nullable(Of Double), ByVal amount As Global.System.Nullable(Of Double), ByVal Original_Id As Integer, ByVal Original_name As String, ByVal Original_meterValue As Global.System.Nullable(Of Double), ByVal Original_amount As Global.System.Nullable(Of Double)) As Integer
            Return Me.Update(Original_Id, name, meterValue, amount, Original_Id, Original_name, Original_meterValue, Original_amount)
        End Function
    End Class
