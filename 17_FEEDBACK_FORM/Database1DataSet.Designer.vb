...
Partial Public Class Database1DataSet
    ...
    Partial Public Class FEEDBACKDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddFEEDBACKRow(ByVal regno As String, ByVal name As String, ByVal year As String, ByVal feedback As String) As FEEDBACKRow
            Dim rowFEEDBACKRow As FEEDBACKRow = CType(Me.NewRow,FEEDBACKRow)
            Dim columnValuesArray() As Object = New Object() {regno, name, year, feedback}
...
Namespace Database1DataSetTableAdapters
    ...
    Partial Public Class FEEDBACKTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[FEEDBACK] ([regno], [name], [year], [feedback]) VALUES (@regno"& _ 
                ", @name, @year, @feedback);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT regno, name, year, feedback FROM FEEDBACK WH"& _ 
                "ERE (regno = @regno)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[FEEDBACK] SET [regno] = @regno, [name] = @name, [year] = @year, [fe"& _ 
                "edback] = @feedback WHERE (([regno] = @Original_regno) AND ((@IsNull_name = 1 AN"& _ 
                "D [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_year = 1 AND [year"& _ 
                "] IS NULL) OR ([year] = @Original_year)) AND ((@IsNull_feedback = 1 AND [feedbac"& _ 
                "k] IS NULL) OR ([feedback] = @Original_feedback)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT regno, name, year, f"& _ 
                "eedback FROM FEEDBACK WHERE (regno = @regno)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT regno, name, year, feedback FROM dbo.FEEDBACK"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_regno As String, ByVal Original_name As String, ByVal Original_year As String, ByVal Original_feedback As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal regno As String, ByVal name As String, ByVal year As String, ByVal feedback As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal regno As String, ByVal name As String, ByVal year As String, ByVal feedback As String, ByVal Original_regno As String, ByVal Original_name As String, ByVal Original_year As String, ByVal Original_feedback As String) As Integer
            If (regno Is Nothing) Then
                Throw New Global.System.ArgumentNullException("regno")
            Else
            ...
            If (Original_regno Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_regno")
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_regno,String)
            End If
            If (Original_name Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_feedback,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal name As String, ByVal year As String, ByVal feedback As String, ByVal Original_regno As String, ByVal Original_name As String, ByVal Original_year As String, ByVal Original_feedback As String) As Integer
            Return Me.Update(Original_regno, name, year, feedback, Original_regno, Original_name, Original_year, Original_feedback)
        End Function
    End Class
